...
import { getMangaById } from '@/lib/api/jikan';
...
export async function generateMetadata({ params }: MangaDetailPageProps): Promise<Metadata> {
  ...
  const item = await getOrCacheItem(id, 'manga', () => getMangaById(id));
  if (!item) return { title: 'Manga no encontrado' };
        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Badge variant="outline">Manga</Badge>
